<template>
  <el-table :data="data" style="width: 100%">
    <el-table-column label="服务名称" width="80" prop="name"></el-table-column>
    <el-table-column label="服务类别" width="80" prop="type"></el-table-column>
    <el-table-column label="服务时间" width="240">
      <template slot-scope="scope">
        <el-popover placement="top">
          <div slot="reference" class="name-wrapper">
            <el-tag size="medium">开始：{{ scope.row.startTime}}</el-tag>
            <el-tag size="medium">结束：{{ scope.row.endTime }}</el-tag>
          </div>
        </el-popover>
      </template>
    </el-table-column>
    <el-table-column label="宠物体重" width="80" prop="weight"></el-table-column>
    <el-table-column label="服务规格" width="80" prop="serviceType"></el-table-column>
    <el-table-column label="耗时" width="70" prop="time"></el-table-column>
    <el-table-column label="员工等级" width="100" prop="stuffLevel"></el-table-column>
    <el-table-column label="价格(小时/次)" width="120" prop="price"></el-table-column>
